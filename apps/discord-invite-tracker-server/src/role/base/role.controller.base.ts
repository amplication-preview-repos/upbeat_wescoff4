...
import { DiscordUserFindManyArgs } from "../../discordUser/base/DiscordUserFindManyArgs";
...
export class RoleControllerBase {
  ...
  @common.Get("/:id/discordUsers")
  @ApiNestedQuery(DiscordUserFindManyArgs)
  async findDiscordUsers(
    @common.Req() request: Request,
    @common.Param() params: RoleWhereUniqueInput
  ): Promise<DiscordUser[]> {
    const query = plainToClass(DiscordUserFindManyArgs, request.query);
    const results = await this.service.findDiscordUsers(params.id, {
      ...query,
      select: {
        id: true,
        createdAt: true,
  ...
  @common.Post("/:id/discordUsers")
  async connectDiscordUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: DiscordUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      discordUsers: {
        connect: body,
  ...
  @common.Delete("/:id/discordUsers")
  async disconnectDiscordUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: DiscordUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
