...
export class SubscriptionResolverBase {
  ...
  async createSubscription(
    ...
    return await this.service.createSubscription({
      ...
      data: {
        ...
        discordUser: args.data.discordUser
          ? {
              connect: args.data.discordUser,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => DiscordUser, {
    nullable: true,
    name: "discordUser",
  })
  async getDiscordUser(
    ...
    const result = await this.service.getDiscordUser(parent.id);
