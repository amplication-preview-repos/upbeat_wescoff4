...
@InputType()
class SubscriptionUpdateManyWithoutDiscordUsersInput {
...
export { SubscriptionUpdateManyWithoutDiscordUsersInput as SubscriptionUpdateManyWithoutDiscordUsersInput };
